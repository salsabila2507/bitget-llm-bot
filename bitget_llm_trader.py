...
RISK_MAX_LEVERAGE = 15
LOW_CONFIDENCE_MAX_LEVERAGE = 7
MID_CONFIDENCE_MAX_LEVERAGE = 10
MAX_MARGIN_PER_TRADE_FRACTION = env_float("MAX_MARGIN_PER_TRADE_FRACTION", 0.45)
...
AUTO_OPEN_CONFIDENCE_SCALPING = env_int("AUTO_OPEN_CONFIDENCE_SCALPING", 80)
AUTO_OPEN_CONFIDENCE_NORMAL = env_int("AUTO_OPEN_CONFIDENCE_NORMAL", 80)
...
PROFIT_GUARD_MAX_LEVERAGE = env_int("PROFIT_GUARD_MAX_LEVERAGE", 10)
PROFIT_GUARD_MAX_LEVERAGE_CONFIDENCE = env_int("PROFIT_GUARD_MAX_LEVERAGE_CONFIDENCE", 85)
...
PROFIT_GUARD_UNKNOWN_HISTORY_CONFIDENCE = env_int("PROFIT_GUARD_UNKNOWN_HISTORY_CONFIDENCE", 80)
